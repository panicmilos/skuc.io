...
public class CreatePredefinedReportRequest {
  private String name;
  private String type;
  private int resolution;
  private List<ParamFilter> paramFilters;

  public CreatePredefinedReportRequest() {
  }

  public CreatePredefinedReportRequest(String name, String type, int resolution, List<ParamFilter> paramFilters) {
    this.name = name;
    this.type = type;
